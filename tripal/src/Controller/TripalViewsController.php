 ...
 */
class TripalViewsController extends ControllerBase{

  /**
   * Constructs the TripalViewsController.
   *
   */
  ...
  /**
   * Provides the main landing page for views.
   */
  public function tripalContentViews() {

    // set the breadcrumb
    $breadcrumb = new Breadcrumb();
    $breadcrumb->addLink(Link::fromTextAndUrl('Home',
        Url::fromRoute('<front>')));
    $breadcrumb->addLink(Link::fromTextAndUrl('Views',
        Url::fromUri('internal:/data-search')));
