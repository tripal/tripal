...
class TripalVocabManager {
  ...
  /**
   * An array of TripalVocab objects to be acted upon.
   */
  protected $vocab_collection;
  ...
  public function saveVocabulary($details, $options = []) {
    ...
    if (!array_key_exists('short_name', $details)) {
      $this->logger->error('The vocabulary short name must be specified using the "short_name" key.');
      return FALSE;
    }
    ...
    if (!array_key_exists('description', $details)) {
      $this->logger->error('The vocabulary must be described using the "description" key.');
      return FALSE;
    }
    ...
    // Finally we save our TripalVocab object:
  ...
  public function getVocabularies($details, $options = []) {
    ...
    if ($this->details == $details) {
      ...
      elseif ($this->vocab_collection) {
        $cache = $this->vocab_collection;
      }
      if ($this->vocab_ids) {
