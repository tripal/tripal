...
class TripalEntityTypeCollectionCreateTest extends TripalTestKernelBase {
  ...
  protected function setUp() :void {
    ...
    // Create mock Tripal ID Space service to return our mock idspace.
   ...
   */
  public function testTripalEntityTypeCollectionCreate() {

    $container = \Drupal::getContainer();
    $content_type = TripalEntityTypeCollection::create($container);
    ...
    $this->assertInstanceOf(TripalEntityTypeCollection::class, $content_type,
   ...
   */
  public function testTripalEntityTypeCollectionCreateContentType() {
