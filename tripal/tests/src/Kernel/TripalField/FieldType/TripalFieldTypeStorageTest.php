...
class TripalFieldTypeStorageTest extends TripalTestKernelBase {
  ...
  public function testTripalEntityFieldStorageInteractions() {
    ...
    // that is supported.
    $this->assertEquals('value', $entity->getTripalFieldInfo('gemstone_name', 'main_property'), "We were not able to retrieve the main property name for the gemstone_name field.");
