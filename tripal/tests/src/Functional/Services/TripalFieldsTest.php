...
/**
 * Tests the basic functions of the TripalFields Service..
 *
 * @group Tripal
 * @group Tripal Content
 */
class TripalFieldsTest extends TripalTestBrowserBase {

  /**
   * Tests the TripalContentTypes class public functions.
   */
  public function testTripalFields() {
    ...
    /** @var \Drupal\tripal\Services\TripalFields $fields_service **/
