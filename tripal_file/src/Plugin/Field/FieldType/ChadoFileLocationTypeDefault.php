...
/**
 * Plugin implementation of default Chado file location field type.
 */
#[FieldType(
...
class ChadoFileLocationTypeDefault extends ChadoFieldItemBase {
   ...
   * @var string
   */
  public static $id = 'chado_file_location_type_default';
