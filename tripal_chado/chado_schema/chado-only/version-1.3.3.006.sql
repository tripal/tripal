...
-- ~~~~~~~~~~~~~~~~~~~~
-- 1.3.3.001
-- Created chado.biomaterial linking tables to stocks and projects.
-- ~~~~~~~~~~~~~~~~~~~~
...
ALTER TABLE analysis DROP CONSTRAINT analysis_c1;
ALTER TABLE analysis ADD  CONSTRAINT analysis_c1 unique (program,programversion, name, sourcename);
...
ALTER TABLE assay ALTER COLUMN arraydesign_id DROP NOT null;
...
ALTER TABLE element ALTER COLUMN arraydesign_id DROP NOT null;
