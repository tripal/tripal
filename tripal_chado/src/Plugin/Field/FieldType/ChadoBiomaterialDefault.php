...
class ChadoBiomaterialDefault extends ChadoFieldItemBase {
  ...
  public static function tripalTypes($field_definition) {
    ...
    $biomaterial_type_term = $mapping->getColumnTermId('cvterm', 'name');
    $biomaterial_type_len = $cvterm_schema_def['fields']['name']['size'];
...
//    // For simplicity, we will use the api function to look up
//    // organism name from organism_id (i.e. taxon_id)
//    $organism_term = $mapping->getColumnTermId('organism', 'organism_id');
//
