...
class ChadoProtocolTypeDefault extends ChadoFieldItemBase {
  ...
  public static function tripalTypes($field_definition) {
    ...
    $uri_term = this::getColumnTermId($object_table, 'uri', 'data:1047');  // text
    $protocoldescription_term = this::getColumnTermId($object_table, 'protocoldescription', 'schema:description');  // text
    $hardwaredescription_term = this::getColumnTermId($object_table, 'hardwaredescription', 'EFO:0000548');  // text
    $softwaredescription_term = this::getColumnTermId($object_table, 'softwaredescription', 'SWO:0000001');  // text

    // Columns from linked tables
    $cvterm_schema_def = $schema->getTableDef('cvterm', ['format' => 'Drupal']);
    $protocol_type_term = this::getColumnTermId('cvterm', 'name', 'schema:aditionalType');
    $protocol_type_len = $cvterm_schema_def['fields']['name']['size'];
    $pub_title_term = this::getColumnTermId('pub', 'title', 'schema:publication');
