...
class ChadoAnalysisTypeDefault extends ChadoFieldItemBase {
  ...
  public static function tripalTypes($field_definition) {
    ...
    $program_term = this::getColumnTermId($object_table, 'program', 'SWO:0000001');
    $program_len = $object_schema_def['fields']['program']['size'];
    $programversion_term = this::getColumnTermId($object_table, 'programversion', 'IAO:0000129');
    $programversion_len = $object_schema_def['fields']['programversion']['size'];
    $algorithm_term = this::getColumnTermId($object_table, 'algorithm', 'IAO:0000064');
    $algorithm_len = $object_schema_def['fields']['algorithm']['size'];
    $sourcename_term = this::getColumnTermId($object_table, 'sourcename', 'schema:name');
    $sourcename_len = $object_schema_def['fields']['sourcename']['size'];
    $sourceversion_term = this::getColumnTermId($object_table, 'sourceversion', 'IAO:0000129');
    $sourceversion_len = $object_schema_def['fields']['sourceversion']['size'];
    $sourceuri_term = this::getColumnTermId($object_table, 'sourceuri', 'data:1047'); // text
