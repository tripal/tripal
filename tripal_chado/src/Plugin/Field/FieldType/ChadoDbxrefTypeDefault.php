...
class ChadoDbxrefTypeDefault extends ChadoFieldItemBase {
  ...
  public static function tripalTypes($field_definition) {
    ...
    $db_term = this::getColumnTermId($object_table, 'db_id', 'ERO:0001716');
    $accession_term = this::getColumnTermId($object_table, 'accession', 'data:2091');
    $accession_len = $object_schema_def['fields']['accession']['size'];
    $version_term = this::getColumnTermId($object_table, 'version', 'IAO:0000129');
    ...
    $db_name_term = this::getColumnTermId('db', 'name', 'ERO:0001716');
    $db_name_len = $db_schema_def['fields']['name']['size'];
    $db_description_term = this::getColumnTermId('db', 'description', 'schema:description');
    $db_description_len = $db_schema_def['fields']['description']['size'];
    $db_urlprefix_term = this::getColumnTermId('db', 'urlprefix', 'schema:ItemPage');
    $db_urlprefix_len = $db_schema_def['fields']['urlprefix']['size'];
    $db_url_term = this::getColumnTermId('db', 'url', 'schema:url');
