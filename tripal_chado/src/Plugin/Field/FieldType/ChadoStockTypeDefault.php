...
class ChadoStockTypeDefault extends ChadoFieldItemBase {
  ...
  public static function tripalTypes($field_definition) {
    ...
    $stock_type_term = this::getColumnTermId('cvterm', 'name', 'schema:additionalType');
    $stock_type_len = $cvterm_schema_def['fields']['name']['size'];
    $infraspecific_type_term = this::getColumnTermId('cvterm', 'name', 'local:infraspecific_type');
    ...
    $common_name_term = this::getColumnTermId('organism', 'common_name', 'NCBITaxon:common_name');
