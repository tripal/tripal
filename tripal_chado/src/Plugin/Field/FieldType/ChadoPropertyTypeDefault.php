...
class ChadoPropertyTypeDefault extends ChadoFieldItemBase {
  ...
  public static function tripalTypes($field_definition) {
    ...
    $link_term = this::getColumnTermId($prop_table, $prop_fk_col, self::$record_id_term);
    $value_term = this::getColumnTermId($prop_table, 'value', 'NCIT:C25712');
    $rank_term = this::getColumnTermId($prop_table, 'rank', 'OBCS:0000117');
    $type_id_term = this::getColumnTermId($prop_table, 'type_id', 'schema:additionalType');
