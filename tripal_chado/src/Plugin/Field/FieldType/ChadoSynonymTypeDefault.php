...
class ChadoSynonymTypeDefault extends ChadoFieldItemBase {
  ...
  public static function tripalTypes($field_definition) {
    ...
    $syn_name_term = this::getColumnTermId('synonym', 'name', 'schema:name');
    $syn_name_len = $synonym_table_def['fields']['name']['size'];
    $syn_type_id_term = this::getColumnTermId('synonym', 'type_id', 'schema:additionalType');
    $syn_type_name_len = $cvterm_table_def['fields']['name']['size'];

    // Synonym linker table fields
    $linker_fkey_id_term = this::getColumnTermId($linker_table, $linker_fkey_column, self::$record_id_term);
    $linker_synonym_id_term = this::getColumnTermId($linker_table, 'synonym_id', 'schema:alternateName');
    $linker_is_current_term = this::getColumnTermId($linker_table, 'is_current', 'local:is_current');
    $linker_is_internal_term = this::getColumnTermId($linker_table, 'is_internal', 'local:is_internal');
    $linker_pub_id_term = this::getColumnTermId($linker_table, 'pub_id', 'schema:publication');
