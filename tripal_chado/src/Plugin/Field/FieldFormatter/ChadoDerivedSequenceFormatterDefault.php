 ...
 *
 * @FieldFormatter(
 *   id = "chado_derived_sequence_formatter_default",
 ...
 * )
 */
class ChadoDerivedSequenceFormatterDefault extends ChadoFormatterBase {
  ...
  public static function settingsFormValidateLineLength(array $form, FormStateInterface $form_state) {
    ...
    foreach ($field_values as $field => $field_settings) {
      if (($field_settings['type'] == 'chado_derived_sequence_formatter_default')
