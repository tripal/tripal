...
/**
 * Pub Importer implementation of the TripalImporterBase.
 *
 *  @TripalImporter(
 *    id = "chado_pub_loader",
 *    label = @Translation("Chado Pub File Loader"),
 *    description = @Translation("Import a Pub file into Chado"),
 *    file_types = {"gff","gff3"},
 *    upload_description = @Translation("Please provide the Pub file."),
 *    upload_title = @Translation("Pub File"),
 *    use_analysis = False,
 *    require_analysis = False,
 *    button_text = @Translation("Import Pub file"),
 *    file_upload = False,
 *    file_load = False,
 *    file_remote = False,
 *    file_required = False,
 ...
 *    callback_path = "src/api/tripal_chado.pub_importers.api.php",
 *  )
 */
class PubImporter extends ChadoImporterBase {
  /**
