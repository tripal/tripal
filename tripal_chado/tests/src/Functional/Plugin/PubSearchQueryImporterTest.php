...
class PubSearchQueryImporterTest extends ChadoTestBrowserBase
{
  ...
  public function testPubSearchQueryImporterSimpleTest()
  {
    ...
    $sql = "INSERT INTO {1:tripal_pub_library_query} (name,criteria) VALUES (:name,:criteria);";
    $args = [
      ':name' => 'Populus',
    ...
    $results = $public->query("SELECT * FROM {1:tripal_pub_library_query} WHERE name = 'Populus';");
    $query_id = NULL;
