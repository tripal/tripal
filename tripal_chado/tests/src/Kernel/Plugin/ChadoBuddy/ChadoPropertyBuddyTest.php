...
class ChadoPropertyBuddyTest extends ChadoTestKernelBase {
  ...
  public function testPropertyMethods() {
    ...
    $chado_buddy_record = $instance->updateProperty('project', 1, ['projectprop.type_id' => 2, 'projectprop.value' => 'prop002'],
    ...
    $chado_buddy_record = $instance->insertProperty('project', 1, ['projectprop.value' => 'prop005',
