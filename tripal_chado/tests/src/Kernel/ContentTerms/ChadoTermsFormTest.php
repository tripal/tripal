...
/**
 * Tests the terms view and forms.
 *
 * @group ContentTerms
 */
#[Group('form')]
...
class ChadoTermsFormTest extends TripalTestKernelBase {
...
#    $this->installEntitySchema('tripal_layout_default_view');
    $this->installEntitySchema('tripal_cv_admin_cvterms');
  }
  ...
  public static function provideConfigEntities() {
    ...
    $scenarios['cvterm_view'] = [
      'form_class' => '\Drupal\tripal_chado\Form\ChadoCvtermForm',
#\Drupal\tripal_layout\Form\TripalLayoutDefaultViewDeleteForm',
      'config_entity_type' => 'tripal_cv_admin_cvterms',
