...
That said, there are still situations in which you may want to support additional data storage backends such as graph databases, NoSQL databases, or flat files such as the variant call format (VCF). Tripal seamlessly supports additional data storage backends through a variety of APIs which will be described here.
