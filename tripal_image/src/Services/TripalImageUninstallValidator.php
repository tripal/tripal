...
/**
 * Service to assist with uninstalling the tripal_image module.
 */
class TripalImageUninstallValidator implements ModuleUninstallValidatorInterface {
  ...
  /**
   * Constructs a new TripalImageUninstallValidator object.
   *
  ...
  public function validate($module) {
    $reasons = [];
    if ($module == 'tripal_image') {
      // Uninstall will be blocked if there are any field storages
      // present for the tripal_image module.
