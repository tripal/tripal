...
class TripalImageRebuildServiceTest extends ChadoTestKernelBase {
   ...
   * @var array
   */
  protected static $modules = ['system', 'user', 'tripal', 'tripal_chado', 'tripal_image', 'filter', 'views'];
   ...
   */
  public function testTripalImageRebuildService() {

    $config = Yaml::parseFile(__DIR__ . '/TripalImageRebuildServiceTest.yml');
